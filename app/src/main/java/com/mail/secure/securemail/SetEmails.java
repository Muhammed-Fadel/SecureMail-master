...
//    private static final String password = ".1234567";
    ...
    protected Void doInBackground(Void... params) {
        ...
        final String password = user.getPassword();
            ...
            props.put("mail.smtp.ssl.trust", "192.168.1.15");//هذي ما اتوقع منها فايده الا في النت بينز
            props.put("mail.smtp.host", "192.168.1.15");//تحدد السيرفر
      //  props.setProperty( "mail.smtp.socketFactory.class", "com.mail.secure.securemail.MySSLSocketFactory" ); // تحل مشكله الشهاده مع الجيميل
            props.put("mail.smtp.port", "587");// تحدد البورت
